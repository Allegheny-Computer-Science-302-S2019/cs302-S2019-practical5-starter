...
# cs302-S2019-practical5-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 5 in Computer Science 302. Since
...
- src/www/travels.html:
  ...
  - Contains exactly one use of a `title` tag with `My Travel Checklist` as content
  - Contains exactly one use of an `h1` tag with `My Travel Checklist` as content
  ...
  - Contains exactly three uses of a `th` tag with the appropriate content
  - Contains exactly five uses of a `tr` tag with the appropriate content
  - Contains exactly five uses of a `td` tag with the appropriate content
...
[Travel Checklist Example](images/travels_example.png)
...
```
git remote add download git@github.com:Allegheny-Computer-Science-302-S2019/cs302-S2019-practical5-starter.git
```
...
you can go to the [Computer Science 302 Practical 5
Starter](https://github.com/Allegheny-Computer-Science-302-S2019/cs302-S2019-practical5-starter)
